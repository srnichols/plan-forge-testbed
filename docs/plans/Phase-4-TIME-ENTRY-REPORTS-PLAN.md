...
### Forbidden Actions
- DO NOT modify existing controllers (ClientsController, InvoicesController, ProjectsController, TimeEntriesController — the last is owned by Phase 2.5, Time Entry CRUD)
