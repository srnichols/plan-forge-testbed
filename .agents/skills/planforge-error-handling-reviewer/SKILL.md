...
metadata:
  author: plan-forge
  source: .github/agents/error-handling-reviewer.agent.md
---
...
- **Before reviewing**: `search_thoughts("error handling patterns", project: "TimeTracker", created_by: "copilot-vscode", type: "convention")` — load prior error handling decisions and accepted patterns
- **After review**: `capture_thought("Error handling review: N findings — [key issues]", project: "TimeTracker", created_by: "copilot-vscode", source: "error-handling-reviewer", type: "postmortem")` — persist findings for trend tracking
