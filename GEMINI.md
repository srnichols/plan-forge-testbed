...
> Auto-generated by Plan Forge. Includes project instructions + guardrail imports.
> Regenerate with: re-run setup with -Agent gemini
...
The following guardrails are imported from Plan Forge instruction files. Gemini CLI auto-loads these via `@` imports.
...
@.github/instructions/dapr.instructions.md
...
@.github/instructions/errorhandling.instructions.md
...
@.github/instructions/messaging.instructions.md

### multi-environment

@.github/instructions/multi-environment.instructions.md
