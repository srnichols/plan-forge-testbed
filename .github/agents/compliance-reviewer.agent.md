...
- **Before reviewing**: `search_thoughts("compliance findings", project: "MyTimeTracker", created_by: "copilot-vscode", type: "convention")` — loads prior GDPR/SOC2 findings and remediation patterns
- **After review**: `capture_thought("Compliance Reviewer: <N findings — key issues>", project: "MyTimeTracker", created_by: "copilot-vscode", source: "agent-compliance-reviewer")` — persists compliance violations and regulatory remediation patterns
