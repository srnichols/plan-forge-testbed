...
- **Before reviewing**: `search_thoughts("observability review findings", project: "MyTimeTracker", created_by: "copilot-vscode", type: "convention")` — loads prior logging gaps and metric patterns
- **After review**: `capture_thought("Observability Reviewer: <N findings — key issues>", project: "MyTimeTracker", created_by: "copilot-vscode", source: "agent-observability-reviewer")` — persists observability gaps and instrumentation recommendations
