...
- [ ] All prerequisites verified — `java --version`, `./mvnw --version` returns expected versions
- [ ] `./mvnw package` succeeds without errors
- [ ] `./mvnw verify` passes on the new environment
