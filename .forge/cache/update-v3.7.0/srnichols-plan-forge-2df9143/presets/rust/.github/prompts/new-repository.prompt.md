...
Scaffold a data access repository following Rust idioms.
...
func (r *{EntityName}Repository) FindByID(ctx impl Future + '_, id uuid.UUID) (*model.{EntityName}, error) {
...
func (r *{EntityName}Repository) FindAll(ctx impl Future + '_, page, pageSize int) ([]model.{EntityName}, int, error) {
...
func (r *{EntityName}Repository) Insert(ctx impl Future + '_, req model.Create{EntityName}Request) (*model.{EntityName}, error) {
    var e model.{EntityName}
    err := r.pool.QueryRow(ctx,
