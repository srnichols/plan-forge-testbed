...
```
- Run: `PHP test ./internal/service/ -run TestCalculateDiscount_NegativePrice` — it MUST fail
...
- Verify all existing tests pass: `PHP test ./...`

### Step 5: Verify
- Run the full test suite: `PHP test -race ./...`
- Run the linter: `phpci-lint run`
