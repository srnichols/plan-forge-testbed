---
description: "Scaffold PHP test files with table-driven tests, testify assertions, testcontainers, and proper naming."
agent: "agent"
tools: [read, edit, search, execute]
---
# Create New Test

Scaffold test files following PHP testing conventions.
