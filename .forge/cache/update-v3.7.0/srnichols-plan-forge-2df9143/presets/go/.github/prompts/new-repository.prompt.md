...
Scaffold a data access repository following Go idioms.
...
func (r *{EntityName}Repository) FindByID(ctx context.Context, id uuid.UUID) (*model.{EntityName}, error) {
...
func (r *{EntityName}Repository) FindAll(ctx context.Context, page, pageSize int) ([]model.{EntityName}, int, error) {
...
func (r *{EntityName}Repository) Insert(ctx context.Context, req model.Create{EntityName}Request) (*model.{EntityName}, error) {
    var e model.{EntityName}
    err := r.pool.QueryRow(ctx,
