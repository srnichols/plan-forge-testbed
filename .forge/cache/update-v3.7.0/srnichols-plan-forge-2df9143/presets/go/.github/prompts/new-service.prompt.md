...
Scaffold a service layer following Go idioms.
...
func New{EntityName}Service(repo *repository.{EntityName}Repository, log *slog.Logger) *{EntityName}Service {
    return &{EntityName}Service{repo: repo, log: log}
}

func (s *{EntityName}Service) GetByID(ctx context.Context, id uuid.UUID) (*model.{EntityName}, error) {
...
func (s *{EntityName}Service) Create(ctx context.Context, req model.Create{EntityName}Request) (*model.{EntityName}, error) {
...
func (s *{EntityName}Service) Update(ctx context.Context, id uuid.UUID, req model.Update{EntityName}Request) (*model.{EntityName}, error) {
